var deductionAutofill = function deductionAutofill() {
    ...
    const actualCode = `
$(function() {
    var chosenSelectComponent = $("#field_deduction_code_chzn");
    var targetSelectComponent = $("select#field-deduction_code");

    if (
        chosenSelectComponent.length > 0 &&
        targetSelectComponent.length > 0
    ) {
